									...
									<h2 class="large-title text-height-12 text-center">
									  ...
									  <form class="row g-3" id="" method="post" action="payment-processing.php">
										...
										<div class="col-md-12">
											...
											<input type="text" class="form-control" id="inputEmail4" value="" name="payname" id="payname" >
										</div>
										<div class="col-md-6">
										...
										<div class="col-6">
											...
											<input type="text" class="form-control" placeholder="0.00"  id="amount" name="amount" value="">
										</div>
										...
										<div class="col-md-12">
											...
											<input class="form-check-input" type="radio" name="cardtype" id="cardtype" value="visa">
											<label class="form-check-label" for="inlineRadio1">Visa</label>
											</div>
											<div class="form-check form-check-inline">
											<input class="form-check-input" type="radio" name="cardtype" id="inlineRadio2cardtype" value="master">
